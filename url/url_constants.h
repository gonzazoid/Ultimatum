...
COMPONENT_EXPORT(URL) extern const char kHashNetHashScheme[];
COMPONENT_EXPORT(URL) extern const char16_t kHashNetHashScheme16[];
COMPONENT_EXPORT(URL) extern const char kHashNetSignedScheme[];
COMPONENT_EXPORT(URL) extern const char16_t kHashNetSignedScheme16[];
COMPONENT_EXPORT(URL) extern const char kHashNetRelatedScheme[];
COMPONENT_EXPORT(URL) extern const char16_t kHashNetRelatedScheme16[];
