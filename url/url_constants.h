...
inline constexpr char kHashNetHashScheme[] = "hash";
inline constexpr char16_t kHashNetHashScheme16[] = u"hash";
inline constexpr char kHashNetSignedScheme[] = "signed";
inline constexpr char16_t kHashNetSignedScheme16[] = u"signed";
inline constexpr char kHashNetRelatedScheme[] = "related";
inline constexpr char16_t kHashNetRelatedScheme16[] = u"related";
