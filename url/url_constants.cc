...
const char kHashNetHashScheme[] = "hash";
const char16_t kHashNetHashScheme16[] = u"hash";
const char kHashNetSignedScheme[] = "signed";
const char16_t kHashNetSignedScheme16[] = u"signed";
const char kHashNetRelatedScheme[] = "related";
const char16_t kHashNetRelatedScheme16[] = u"related";
