...
Basicaly the same way you build chromium, checkout the sources and add to ``args.gn`` this: 
...
You can change symbols level as you wish, the point is to build with ``enable_desktop_android_extensions``.

Run gen and then run build, [as usual](https://chromium.googlesource.com/chromium/src/+/main/docs/linux/build_instructions.md). After build is complete you'll get your apk to play with.
