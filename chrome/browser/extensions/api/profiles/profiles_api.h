...
// parameter
class ProfilesSetParameterFunction : public ProfilesFunction {
 public:
  DECLARE_EXTENSION_FUNCTION("profiles.setParameter", PROFILES_SETPARAMETER)

 protected:
  ~ProfilesSetParameterFunction() override {}

  // ExtensionFunction:
  ResponseAction Run() override;
};

class ProfilesSetParameterSubstitutionFunction : public ProfilesFunction {
 public:
  DECLARE_EXTENSION_FUNCTION("profiles.setParameterSubstitution", PROFILES_SETPARAMETERSUBSTITUTION)

 protected:
  ~ProfilesSetParameterSubstitutionFunction() override {}
