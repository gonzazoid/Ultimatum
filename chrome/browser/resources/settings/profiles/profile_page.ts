...
export class ProfilePageElement extends ProfilePageElementBase {
  ...
  declare public prefs: object;
  declare private isManaged_: boolean;

  declare private userAgentSubstitution: chrome.settingsPrivate.PrefObject<boolean>;
  declare private userAgent: string;
  declare private userAgentChangedAndValid: boolean;
  declare private oldUserAgent: String;

  declare private productSubSubstitution: chrome.settingsPrivate.PrefObject<boolean>;
  declare private productSub: string;
  declare private productSubChangedAndValid: boolean;
  declare private oldProductSub: String;

  declare private platformSubstitution: chrome.settingsPrivate.PrefObject<boolean>;
  declare private platform: string;
  declare private platformChangedAndValid: boolean;
  declare private oldPlatform: String;

  declare private vendorSubstitution: chrome.settingsPrivate.PrefObject<boolean>;
  declare private vendor: string;
  declare private vendorChangedAndValid: boolean;
  declare private oldVendor: String;
