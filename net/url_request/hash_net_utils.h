...
NET_EXPORT base::Value::List VerifySignedResponses(const std::string& msg, const std::string& private_key, const GURL& url);
NET_EXPORT base::Value::List VerifyRelatedResponses(std::string msg, const std::string& private_key, const GURL& url);
}
