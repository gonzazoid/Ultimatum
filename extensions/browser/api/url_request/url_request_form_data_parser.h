...
#ifndef EXTENSIONS_BROWSER_API_URL_REQUEST_FORM_DATA_PARSER_H_
#define EXTENSIONS_BROWSER_API_URL_REQUEST_FORM_DATA_PARSER_H_
...
class UrlRequestFormDataParser {
 public:
  ...
  UrlRequestFormDataParser(const UrlRequestFormDataParser&) = delete;
  UrlRequestFormDataParser& operator=(const UrlRequestFormDataParser&) = delete;

  virtual ~UrlRequestFormDataParser();

  // Creates a correct parser instance based on the |request_headers|. Returns
  // null on failure.
  static std::unique_ptr<UrlRequestFormDataParser> Create(
  ...
  static std::unique_ptr<UrlRequestFormDataParser> CreateFromContentTypeHeader(
 ...
 protected:
  UrlRequestFormDataParser();
};

}  // namespace extensions

#endif  // EXTENSIONS_BROWSER_API_URL_REQUEST_FORM_DATA_PARSER_H_
