...
// to an UrlRequestUploadDataPresenter.
class UploadDataSource {
 public:
  virtual ~UploadDataSource() {}

  virtual void FeedToPresenter(UrlRequestUploadDataPresenter* presenter) = 0;
};
...
class BytesUploadDataSource : public UploadDataSource {
 public:
  ...
  // UploadDataSource:
  void FeedToPresenter(UrlRequestUploadDataPresenter* presenter) override {
...
std::optional<base::Value::Dict> CreateRequestBodyData(
  ...
  UrlRequestParsedDataPresenter parsed_data_presenter(request_headers);
  UrlRequestRawDataPresenter raw_data_presenter;
  UrlRequestUploadDataPresenter* const presenters[] = {
...
UrlRequestInfoInitParams::UrlRequestInfoInitParams() = default;

UrlRequestInfoInitParams::UrlRequestInfoInitParams(
    uint64_t request_id,
  ...
  url_request_type = ToUrlRequestResourceType(request, is_download);
...
UrlRequestInfoInitParams::UrlRequestInfoInitParams(
    UrlRequestInfoInitParams&& other) = default;

UrlRequestInfoInitParams& UrlRequestInfoInitParams::operator=(
    UrlRequestInfoInitParams&& other) = default;

UrlRequestInfoInitParams::~UrlRequestInfoInitParams() = default;

void UrlRequestInfoInitParams::InitializeWebViewAndFrameData(
...
UrlRequestInfo::UrlRequestInfo(UrlRequestInfoInitParams params)
    : id(params.id),
      ...
      url_request_type(params.url_request_type),
...
UrlRequestInfo::~UrlRequestInfo() = default;

void UrlRequestInfo::AddResponseInfoFromResourceResponse(
