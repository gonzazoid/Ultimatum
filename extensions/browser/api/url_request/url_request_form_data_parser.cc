...
class UrlRequestFormDataParserUrlEncoded : public UrlRequestFormDataParser {
 public:
  UrlRequestFormDataParserUrlEncoded();

  UrlRequestFormDataParserUrlEncoded(const UrlRequestFormDataParserUrlEncoded&) = delete;
  UrlRequestFormDataParserUrlEncoded& operator=(const UrlRequestFormDataParserUrlEncoded&) = delete;

  ~UrlRequestFormDataParserUrlEncoded() override;
...
// The following class, UrlRequestFormDataParserMultipart, parses forms encoded as
...
class UrlRequestFormDataParserMultipart : public UrlRequestFormDataParser {
 public:
  explicit UrlRequestFormDataParserMultipart(const std::string& boundary_separator);

  UrlRequestFormDataParserMultipart(const UrlRequestFormDataParserMultipart&) = delete;
  UrlRequestFormDataParserMultipart& operator=(const UrlRequestFormDataParserMultipart&) = delete;

  ~UrlRequestFormDataParserMultipart() override;
...
UrlRequestFormDataParser::Result::Result() = default;
UrlRequestFormDataParser::Result::~Result() = default;

void UrlRequestFormDataParser::Result::SetBinaryValue(std::string_view str) {
  value_ = base::Value(
      base::Value::BlobStorage(str.data(), str.data() + str.size()));
}

void UrlRequestFormDataParser::Result::SetStringValue(std::string str) {
  value_ = base::Value(std::move(str));
}

UrlRequestFormDataParser::~UrlRequestFormDataParser() = default;

// static
std::unique_ptr<UrlRequestFormDataParser> UrlRequestFormDataParser::Create(
...
// static
std::unique_ptr<UrlRequestFormDataParser> UrlRequestFormDataParser::CreateFromContentTypeHeader(
  ...
  switch (choice) {
    case URL_ENCODED:
      return std::unique_ptr<UrlRequestFormDataParser>(new UrlRequestFormDataParserUrlEncoded());
    case MULTIPART:
      return std::unique_ptr<UrlRequestFormDataParser>(
          new UrlRequestFormDataParserMultipart(boundary));
    case ERROR_CHOICE:
      return nullptr;
  }
...
UrlRequestFormDataParserUrlEncoded::UrlRequestFormDataParserUrlEncoded()
    : source_set_(false),
...
UrlRequestFormDataParserUrlEncoded::~UrlRequestFormDataParserUrlEncoded() = default;

bool UrlRequestFormDataParserUrlEncoded::AllDataReadOK() {
  // All OK means we read the whole source.
  return source_set_ && source_.empty() && !source_malformed_;
}

bool UrlRequestFormDataParserUrlEncoded::GetNextNameValue(Result* result) {
...
bool UrlRequestFormDataParserUrlEncoded::SetSource(std::string_view source) {
  if (source_set_)
...
// static
bool UrlRequestFormDataParserMultipart::StartsWithPattern(std::string_view input,
                                                const RE2& pattern) {
  return pattern.Match(input, 0, input.size(), RE2::ANCHOR_START, nullptr, 0);
}

UrlRequestFormDataParserMultipart::UrlRequestFormDataParserMultipart(
    const std::string& boundary_separator)
    : dash_boundary_separator_("--" + boundary_separator),
      state_(STATE_INIT),
      patterns_(g_patterns.Pointer()) {}

UrlRequestFormDataParserMultipart::~UrlRequestFormDataParserMultipart() = default;

bool UrlRequestFormDataParserMultipart::AllDataReadOK() {
  return state_ == STATE_FINISHED;
}

bool UrlRequestFormDataParserMultipart::FinishReadingPart(std::string_view* data) {
...
bool UrlRequestFormDataParserMultipart::GetNextNameValue(Result* result) {
...
bool UrlRequestFormDataParserMultipart::SetSource(std::string_view source) {
...
bool UrlRequestFormDataParserMultipart::TryReadHeader(std::string_view* name,
                                            std::string_view* value,
                                            bool* value_assigned,
                                            bool* value_is_binary) {
