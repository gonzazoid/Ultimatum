...
#ifndef EXTENSIONS_BROWSER_API_URL_REQUEST_URL_REQUEST_INFO_H_
#define EXTENSIONS_BROWSER_API_URL_REQUEST_URL_REQUEST_INFO_H_
...
// Helper struct to initialize UrlRequestInfo.
struct UrlRequestInfoInitParams {
  UrlRequestInfoInitParams();

  // Initializes a UrlRequestInfoInitParams from information provided over a
  ...
  UrlRequestInfoInitParams(const UrlRequestInfoInitParams&) = delete;
  UrlRequestInfoInitParams(UrlRequestInfoInitParams&& other);

  UrlRequestInfoInitParams& operator=(const UrlRequestInfoInitParams&) = delete;
  UrlRequestInfoInitParams& operator=(UrlRequestInfoInitParams&& other);
  ...
  UrlRequestResourceType url_request_type = UrlRequestResourceType::OTHER;
  bool is_async = false;
...
// A URL request representation used by UrlRequest API internals. This structure
// carries information about an in-progress request.
struct UrlRequestInfo {
  explicit UrlRequestInfo(UrlRequestInfoInitParams params);

  UrlRequestInfo(const UrlRequestInfo&) = delete;
  UrlRequestInfo& operator=(const UrlRequestInfo&) = delete;
  ...
  const UrlRequestResourceType url_request_type = UrlRequestResourceType::OTHER;
  ...
  // UrlRequest API consumers. This may have a "formData" key and/or a "raw"
  // key. See UrlRequest API documentation for more details.
  std::optional<base::Value::Dict> request_body_data;
...
#endif  // EXTENSIONS_BROWSER_API_URL_REQUEST_URL_REQUEST_INFO_H_
