...
#ifndef EXTENSIONS_BROWSER_API_URL_REQUEST_EXTENSION_URL_REQUEST_EVENT_ROUTER_H_
#define EXTENSIONS_BROWSER_API_URL_REQUEST_EXTENSION_URL_REQUEST_EVENT_ROUTER_H_
...
class UrlRequestEventRouter : public KeyedService {
 public:
  explicit UrlRequestEventRouter(content::BrowserContext* browser_context);
  ~UrlRequestEventRouter() override;
  UrlRequestEventRouter(const UrlRequestEventRouter&) = delete;
  UrlRequestEventRouter& operator=(const UrlRequestEventRouter&) = delete;
  ...
  // Get the instance of the UrlRequestEventRouter for |browser_context|.
  static UrlRequestEventRouter* Get(content::BrowserContext* browser_context);

  static std::vector<std::string> GetEventNames();

  // Internal representation of the urlRequest.RequestFilter type, used to
  ...
  struct RequestFilter {
    ...
    std::vector<UrlRequestResourceType> types;
    int tab_id;
    int window_id;
  };
 ...
 private:
  ...
  bool IsPageLoad(const UrlRequestInfo& request) const;
  ...
  base::WeakPtrFactory<UrlRequestEventRouter> weak_ptr_factory_{this};
};

}  // namespace extensions

#endif  // EXTENSIONS_BROWSER_API_URL_REQUEST_EXTENSION_URL_REQUEST_EVENT_ROUTER_H_
