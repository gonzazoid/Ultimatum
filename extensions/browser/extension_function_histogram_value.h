...
enum HistogramValue {
  ...
  DISKCACHE_KEYS = 1951,
  DISKCACHE_GETENTRY = 1952,
  DISKCACHE_PUTENTRY = 1953,
  DISKCACHE_DELETEENTRY = 1954,
  HSTSCACHE_KEYS = 1955,
  HSTSCACHE_GETENTRY = 1956,
  HSTSCACHE_PUTENTRY = 1957,
  HSTSCACHE_DELETEENTRY = 1958,
  SQLITECACHE_EXEC = 1959,
  LOCALSTORAGES_KEYS = 1960,
  LOCALSTORAGES_GETENTRY = 1961,
  LOCALSTORAGES_PUTENTRY = 1962,
  LOCALSTORAGES_DELETEENTRY = 1963,
  LOCALSTORAGES_FLUSH = 1964,
  LOCALSTORAGES_PURGEMEMORY = 1965,
