...
enum HistogramValue {
  ...
  HSTSCACHE_KEYS = 1958,
  HSTSCACHE_GETENTRY = 1959,
  HSTSCACHE_PUTENTRY = 1960,
  HSTSCACHE_DELETEENTRY = 1961,
  SQLITECACHE_EXEC = 1962,
  LOCALSTORAGES_KEYS = 1963,
  LOCALSTORAGES_GETENTRY = 1964,
  LOCALSTORAGES_PUTENTRY = 1965,
  LOCALSTORAGES_DELETEENTRY = 1966,
  LOCALSTORAGES_FLUSH = 1967,
  LOCALSTORAGES_PURGEMEMORY = 1968,
