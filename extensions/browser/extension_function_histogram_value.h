...
enum HistogramValue {
  ...
  PROFILES_SETPARAMETER = 1941,
  PROFILES_SETPARAMETERSUBSTITUTION = 1942,
  DISKCACHE_KEYS = 1943,
  DISKCACHE_GETENTRY = 1944,
  DISKCACHE_PUTENTRY = 1945,
  DISKCACHE_DELETEENTRY = 1946,
  HSTSCACHE_KEYS = 1947,
  HSTSCACHE_GETENTRY = 1948,
  HSTSCACHE_PUTENTRY = 1949,
  HSTSCACHE_DELETEENTRY = 1950,
  SQLITECACHE_EXEC = 1951,
  LOCALSTORAGES_KEYS = 1952,
  LOCALSTORAGES_GETENTRY = 1953,
  LOCALSTORAGES_PUTENTRY = 1954,
