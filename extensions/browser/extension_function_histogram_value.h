...
enum HistogramValue {
  ...
  DEVELOPERPRIVATE_LOADCRX = 1941,
  PROFILES_SETPARAMETER = 1942,
  PROFILES_SETPARAMETERSUBSTITUTION = 1943,
  DISKCACHE_KEYS = 1944,
  DISKCACHE_GETENTRY = 1945,
  DISKCACHE_PUTENTRY = 1946,
  DISKCACHE_DELETEENTRY = 1947,
  HSTSCACHE_KEYS = 1948,
  HSTSCACHE_GETENTRY = 1949,
  HSTSCACHE_PUTENTRY = 1950,
  HSTSCACHE_DELETEENTRY = 1951,
  SQLITECACHE_EXEC = 1952,
  LOCALSTORAGES_KEYS = 1953,
  LOCALSTORAGES_GETENTRY = 1954,
  LOCALSTORAGES_PUTENTRY = 1955,
  LOCALSTORAGES_DELETEENTRY = 1956,
  LOCALSTORAGES_FLUSH = 1957,
  LOCALSTORAGES_PURGEMEMORY = 1958,
