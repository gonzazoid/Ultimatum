...
enum HistogramValue {
  ...
  DEVELOPERPRIVATE_LOADCRX = 1961,
  PROFILES_SETPARAMETER = 1962,
  PROFILES_SETPARAMETERSUBSTITUTION = 1963,
  DISKCACHE_KEYS = 1964,
  DISKCACHE_GETENTRY = 1965,
  DISKCACHE_PUTENTRY = 1966,
  DISKCACHE_DELETEENTRY = 1967,
  HSTSCACHE_KEYS = 1968,
  HSTSCACHE_GETENTRY = 1969,
  HSTSCACHE_PUTENTRY = 1970,
  HSTSCACHE_DELETEENTRY = 1971,
  SQLITECACHE_EXEC = 1972,
  LOCALSTORAGES_KEYS = 1973,
  LOCALSTORAGES_GETENTRY = 1974,
  LOCALSTORAGES_PUTENTRY = 1975,
  LOCALSTORAGES_DELETEENTRY = 1976,
  LOCALSTORAGES_FLUSH = 1977,
  LOCALSTORAGES_PURGEMEMORY = 1978,
