...
enum HistogramValue {
  ...
  PROFILES_SETPARAMETER = 1951,
  PROFILES_SETPARAMETERSUBSTITUTION = 1952,
  DISKCACHE_KEYS = 1953,
  DISKCACHE_GETENTRY = 1954,
  DISKCACHE_PUTENTRY = 1955,
  DISKCACHE_DELETEENTRY = 1956,
  HSTSCACHE_KEYS = 1957,
  HSTSCACHE_GETENTRY = 1958,
  HSTSCACHE_PUTENTRY = 1959,
  HSTSCACHE_DELETEENTRY = 1960,
  SQLITECACHE_EXEC = 1961,
  LOCALSTORAGES_KEYS = 1962,
  LOCALSTORAGES_GETENTRY = 1963,
  LOCALSTORAGES_PUTENTRY = 1964,
  LOCALSTORAGES_DELETEENTRY = 1965,
  LOCALSTORAGES_FLUSH = 1966,
  LOCALSTORAGES_PURGEMEMORY = 1967,
