...
enum HistogramValue {
  ...
  HSTSCACHE_KEYS = 1904,
  HSTSCACHE_GETENTRY = 1905,
  HSTSCACHE_PUTENTRY = 1906,
  HSTSCACHE_DELETEENTRY = 1907,
  SQLITECACHE_EXEC = 1908,
  LOCALSTORAGES_KEYS = 1909,
  LOCALSTORAGES_GETENTRY = 1910,
  LOCALSTORAGES_PUTENTRY = 1911,
