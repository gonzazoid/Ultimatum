...
enum HistogramValue {
  ...
  PROFILES_SETPARAMETER = 1937,
  PROFILES_SETPARAMETERSUBSTITUTION = 1938,
  DISKCACHE_KEYS = 1939,
  ...
  SQLITECACHE_EXEC = 1947,
  LOCALSTORAGES_KEYS = 1948,
  LOCALSTORAGES_GETENTRY = 1949,
  LOCALSTORAGES_PUTENTRY = 1950,
  LOCALSTORAGES_DELETEENTRY = 1951,
  LOCALSTORAGES_FLUSH = 1952,
  LOCALSTORAGES_PURGEMEMORY = 1953,
