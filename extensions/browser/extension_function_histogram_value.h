...
enum HistogramValue {
  ...
  PROFILES_SETPARAMETER = 1907,
  PROFILES_SETPARAMETERSUBSTITUTION = 1908,
  DISKCACHE_KEYS = 1909,
  DISKCACHE_GETENTRY = 1910,
  DISKCACHE_PUTENTRY = 1911,
  DISKCACHE_DELETEENTRY = 1912,
  HSTSCACHE_KEYS = 1913,
  HSTSCACHE_GETENTRY = 1914,
  HSTSCACHE_PUTENTRY = 1915,
  HSTSCACHE_DELETEENTRY = 1916,
  SQLITECACHE_EXEC = 1917,
  LOCALSTORAGES_KEYS = 1918,
  LOCALSTORAGES_GETENTRY = 1919,
  LOCALSTORAGES_PUTENTRY = 1920,
  LOCALSTORAGES_DELETEENTRY = 1921,
