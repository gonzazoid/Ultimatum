...
enum HistogramValue {
  ...
  PROFILES_SETPARAMETER = 1940,
  PROFILES_SETPARAMETERSUBSTITUTION = 1941,
  DISKCACHE_KEYS = 1942,
  DISKCACHE_GETENTRY = 1943,
  DISKCACHE_PUTENTRY = 1944,
  DISKCACHE_DELETEENTRY = 1945,
  HSTSCACHE_KEYS = 1946,
  HSTSCACHE_GETENTRY = 1947,
  HSTSCACHE_PUTENTRY = 1948,
  HSTSCACHE_DELETEENTRY = 1949,
  SQLITECACHE_EXEC = 1950,
  LOCALSTORAGES_KEYS = 1951,
  LOCALSTORAGES_GETENTRY = 1952,
  LOCALSTORAGES_PUTENTRY = 1953,
  LOCALSTORAGES_DELETEENTRY = 1954,
  LOCALSTORAGES_FLUSH = 1955,
  LOCALSTORAGES_PURGEMEMORY = 1956,
